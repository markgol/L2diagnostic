...
//  L2Diagnostic
//  Author: Mark Stegall
//  Module: Stage1CalibrationDialog.h
//
//
//  Purpose:
...
//  V2.1.0  2026-08-27  Changed files named to reflect generalization
...
#include <QDialog>
#include <QString>
#include "ui_Stage1CalibrationDialog.h"

class Stage1CalibrationDialog : public QDialog
{
    Q_OBJECT

public:
    explicit Stage1CalibrationDialog(QWidget* parent = nullptr)
        : QDialog(parent)
    {
        ui.setupUi(this);
