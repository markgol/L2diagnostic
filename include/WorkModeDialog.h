...
public:
        ...
        : QDialog(parent)
    {
        ...
        // Get Workmode button
        connect(ui.btnGetWM, &QPushButton::clicked,
                this, &WorkmodeDialog::SendGetWorkmode);
    ...
    // This will send a get L2 params request
    // That L2 params packet packet the is returned
    // contains the current workmode
    void SendGetWorkmode();
    ...
    // Setting the workmode does not perform a L2 reset
    // This only sets the desired workmode in the app
