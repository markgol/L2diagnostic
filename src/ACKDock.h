...
//
//  V.02.5  2026-01-10  added ACK packet dockable dialog
//
//--------------------------------------------------------
...
// ui variables autogenerated from StatsDock.ui
//
//--------------------------------------------------------
...
// m_StatsDock->hide();   // hide window
// m_StatsDock->show();   // show window
//
//--------------------------------------------------------

class ACKDock : public QDockWidget
{
    Q_OBJECT

public:
    explicit ACKDock(QWidget* parent = nullptr);
    ~ACKDock();

    // use these calls to update this dock window
    void updateACK(LidarAckData& Ack);
