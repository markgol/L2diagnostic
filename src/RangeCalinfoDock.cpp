...
//--------------------------------------------------------
RangeCalinfoDock::RangeCalinfoDock(QWidget* parent)
    : QDockWidget(parent)
    , ui(new Ui::RangeCalinfoDock)
{
    ui->setupUi(this);
}
...
//--------------------------------------------------------
RangeCalinfoDock::~RangeCalinfoDock()
{
    delete ui;
}
...
//--------------------------------------------------------
void RangeCalinfoDock::updateInfo(const RangeCalibrationInfo& info, bool valid)
{
    // Calibration
...
//  signal callback to update Stats window
//--------------------------------------------------------
void RangeCalinfoDock::SetMessage(const std::string& message)
{
    QString ResultString;
